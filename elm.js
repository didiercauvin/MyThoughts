...
var _user$project$Main$modelValidator = _rtfeldman$elm_validate$Validate$all(
	{
		ctor: '::',
		_0: A2(
...
var _user$project$Main$renderError = function (error) {
	return A2(
...
var _user$project$Main$renderErrors = function (errors) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$Main$renderError, errors));
};
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'NewCategory':
				var _p3 = model.currentCategory;
				if (_p3.ctor === 'Just') {
					var _p5 = _p3._0;
					var _p4 = A2(_rtfeldman$elm_validate$Validate$validate, _user$project$Main$modelValidator, _p5);
					if (_p4.ctor === '[]') {
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									categories: {ctor: '::', _0: _p5, _1: model.categories},
									currentCategory: _elm_lang$core$Maybe$Nothing,
									isPopUpActive: false
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
						...
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									currentCategory: _elm_lang$core$Maybe$Just(
										{errors: _p4, name: _p5.name, links: _p5.links})
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{categories: model.categories, currentCategory: _elm_lang$core$Maybe$Nothing, isPopUpActive: false}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{currentCategory: _elm_lang$core$Maybe$Nothing, isPopUpActive: false}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
...
var _user$project$Main$addCss = function (path) {
	return A3(
		...
		'link',
		{
			...
			_1: {
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled_Attributes$href(path),
				_1: {ctor: '[]'}
			}
		},
		{ctor: '[]'});
};
var _user$project$Main$bulma = _user$project$Main$addCss('https://cdnjs.cloudflare.com/ajax/libs/bulma/0.6.1/css/bulma.min.css');
var _user$project$Main$create = _rtfeldman$elm_css$Css$batch(
	{
		ctor: '::',
...
var _user$project$Main$tagline = _rtfeldman$elm_css$Css$batch(
	{
		ctor: '::',
...
var _user$project$Main$title = _rtfeldman$elm_css$Css$batch(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$color(
...
var _user$project$Main$listCategories = _rtfeldman$elm_css$Css$batch(
	{
		ctor: '::',
...
var _user$project$Main$categories = function (categories) {
	var _p6 = _elm_lang$core$List$length(categories);
	if (_p6 === 0) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
				...
				_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
					{
						ctor: '::',
						_0: _user$project$Main$listCategories,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
...
var _user$project$Main$subheader = _rtfeldman$elm_css$Css$batch(
	{
		ctor: '::',
...
var _user$project$Main$mainHeader = _rtfeldman$elm_css$Css$batch(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$position(_rtfeldman$elm_css$Css$relative),
		_1: {
...
var _user$project$Main$bandeau = A2(
	_rtfeldman$elm_css$Html_Styled$div,
	{
		...
		_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
			{
				ctor: '::',
				_0: _user$project$Main$mainHeader,
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled$text('MyThoughts'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
...
var _user$project$Main$content = _rtfeldman$elm_css$Css$batch(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$width(
			_rtfeldman$elm_css$Css$px(1060)),
		_1: {
			ctor: '::',
			_0: A2(
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {categories: a, currentCategory: b, isPopUpActive: c};
	});
var _user$project$Main$Category = F3(
	function (a, b, c) {
		return {name: a, links: b, errors: c};
	});
var _user$project$Main$CancelEditCategory = {ctor: 'CancelEditCategory'};
var _user$project$Main$NewCategory = {ctor: 'NewCategory'};
var _user$project$Main$EditCategoryName = function (a) {
	return {ctor: 'EditCategoryName', _0: a};
};
var _user$project$Main$renderEditCategory = function (category) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{ctor: '[]'},
		{
			...
			_0: function () {
				var _p7 = category;
				if (_p7.ctor === 'Just') {
					return _user$project$Main$renderErrors(_p7._0.errors);
				} else {
					return _user$project$Main$renderErrors(
						{ctor: '[]'});
				}
			}(),
			_1: {
						...
						_0: A2(
							_rtfeldman$elm_css$Html_Styled$input,
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _rtfeldman$elm_css$Html_Styled_Events$onInput(_user$project$Main$EditCategoryName),
										_1: {ctor: '[]'}
									}
								}
							},
...
var _user$project$Main$TogglePopup = {ctor: 'TogglePopup'};
var _user$project$Main$subbandeau = A2(
	_rtfeldman$elm_css$Html_Styled$div,
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(_user$project$Main$TogglePopup),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled$text('Créer catégorie'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
...
var _user$project$Main$renderModal = function (model) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{
			ctor: '::',
					...
					},
					{
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _rtfeldman$elm_css$Html_Styled$text('Nouvelle catégorie'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										_rtfeldman$elm_css$Html_Styled$button,
										{
											...
											_1: {
												ctor: '::',
												_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(_user$project$Main$CancelEditCategory),
												_1: {
													ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _user$project$Main$renderEditCategory(model.currentCategory),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
										...
										_0: A2(
											_rtfeldman$elm_css$Html_Styled$button,
											{
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(_user$project$Main$NewCategory),
														_1: {ctor: '[]'}
													}
												}
											},
