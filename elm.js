...
var _user$project$Category_Model$emptyModel = {
	category: {
		name: '',
		links: {ctor: '[]'}
	},
...
var _user$project$Category_Model$Model = F2(
	function (a, b) {
		return {category: a, errors: b};
	});
var _user$project$Category_Model$Category = F2(
	function (a, b) {
		return {name: a, links: b};
	});

var _user$project$Category_Update$modelValidator = _rtfeldman$elm_validate$Validate$all(
	{
		ctor: '::',
		_0: A2(
...
var _user$project$Category_Update$Edit = function (a) {
	return {ctor: 'Edit', _0: a};
};

var _user$project$Category_View$renderError = function (error) {
	return A2(
...
var _user$project$Category_View$renderErrors = function (errors) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$Category_View$renderError, errors));
};
var _user$project$Category_View$renderForm = function (category) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{
			ctor: '::',
			...
			_0: A2(
				_rtfeldman$elm_css$Html_Styled$input,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Events$onInput(_user$project$Category_Update$Edit),
							_1: {ctor: '[]'}
						}
					}
				},
...
var _user$project$Category_View$view = function (model) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Category_View$renderErrors(model.errors),
			_1: {
				ctor: '::',
				_0: _user$project$Category_View$renderForm(model.category),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Style$categoryItemButton = _rtfeldman$elm_css$Css_Foreign$global(
	{
		ctor: '::',
		_0: A2(
			_rtfeldman$elm_css$Css_Foreign$selector,
...
var _user$project$Style$listCategories = _rtfeldman$elm_css$Css$batch(
	{
		ctor: '::',
...
var _user$project$Style$subheader = _rtfeldman$elm_css$Css$batch(
	{
		ctor: '::',
...
var _user$project$Style$mainHeader = _rtfeldman$elm_css$Css$batch(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$position(_rtfeldman$elm_css$Css$relative),
		_1: {
...
var _user$project$Main$bandeau = A2(
	_rtfeldman$elm_css$Html_Styled$div,
	{
		...
		_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
			{
				ctor: '::',
				_0: _user$project$Style$mainHeader,
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	},
...
var _user$project$Main$DeleteCategory = function (a) {
	return {ctor: 'DeleteCategory', _0: a};
};
								...
								_1: {
									...
									_1: {
										...
										_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(
											_user$project$Main$DeleteCategory(category.name)),
										_1: {ctor: '[]'}
									}
								}
							},
...
var _user$project$Main$categories = function (categories) {
	var _p0 = _elm_lang$core$List$length(categories);
	if (_p0 === 0) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
...
var _user$project$Main$AddCategory = {ctor: 'AddCategory'};
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			...
			case 'MsgForCategory':
				var _p2 = A2(_user$project$Category_Update$update, _p1._0, model.currentCategoryModel);
				var categoryModel = _p2._0;
				var cmdMsg = _p2._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			case 'CancelEditCategory':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{isPopUpActive: !model.isPopUpActive, currentCategoryModel: _user$project$Category_Model$emptyModel}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
...
var _user$project$Main$subbandeau = A2(
	_rtfeldman$elm_css$Html_Styled$div,
	{
		...
		_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
			{
				ctor: '::',
				_0: _user$project$Style$subheader,
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	},
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										_user$project$Main$MsgForCategory,
										_user$project$Category_View$view(model.currentCategoryModel)),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
										...
										_0: A2(
											_rtfeldman$elm_css$Html_Styled$button,
											{
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(_user$project$Main$AddCategory),
														_1: {ctor: '[]'}
													}
												}
											},
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"tags":{"DeleteCategory":["String"],"CancelEditCategory":[],"MsgForCategory":["Category.Update.Msg"],"TogglePopup":[],"AddCategory":[]},"args":[]},"Category.Update.Msg":{"tags":{"Edit":["String"]},"args":[]}}},"versions":{"elm":"0.18.0"}});
}
