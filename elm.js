...
var author$project$Main$init = _Utils_Tuple2(
	author$project$Main$Category(author$project$Page$Category$initModel),
	elm$core$Platform$Cmd$none);
var author$project$Main$CategoryMsg = function (a) {
	return {$: 'CategoryMsg', a: a};
};
var author$project$Category$Category = F3(
	function (id, name, links) {
		return {id: id, links: links, name: name};
	});
...
var author$project$Page$Category$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Edit':
				var name = msg.a;
			...
			case 'Append':
				if (elm$core$String$isEmpty(model.newCategoryName)) {
					...
					var categories = A2(
						elm$core$List$cons,
						A3(author$project$Category$Category, model.id, model.newCategoryName, _List_Nil),
						model.categories);
					return _Utils_Tuple2(
						_Utils_update(
							model,
			...
			case 'Select':
				...
				var category = elm$core$List$head(
					A2(
						...
						function (cat) {
							return _Utils_eq(cat.id, id);
						},
						model.categories));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{isPopUpActive: true, selectedCategory: category}),
					elm$core$Platform$Cmd$none);
			case 'Delete':
				var id = msg.a;
				var categories = A2(
...
var author$project$Main$update = F2(
	function (msg, _n0) {
		...
		var categoryMsg = _n1.a.a;
		var category = _n1.b.a;
		var _n2 = A2(author$project$Page$Category$update, categoryMsg, category);
		var categoryModel = _n2.a;
		var cmdMsg = _n2.b;
		return _Utils_Tuple2(
			author$project$Main$Category(categoryModel),
			A2(elm$core$Platform$Cmd$map, author$project$Main$CategoryMsg, cmdMsg));
	});
...
var author$project$Page$styleHeader = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			...
			A3(rtfeldman$elm_css$Css$rgb, 96, 181, 204))
		]));
...
var author$project$Style$tagline = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var author$project$Style$title = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$color(
...
var author$project$Page$viewHeader = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[author$project$Page$styleHeader]))
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[author$project$Style$title]))
				]),
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$text('Mes liens')
				])),
			A2(
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[author$project$Style$tagline]))
				]),
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$text('Pour mettre de côté mes liens utiles')
				]))
		]));
...
var author$project$Style$addCss = function (path) {
	return A3(
...
var author$project$Style$bulma = author$project$Style$addCss('https://cdnjs.cloudflare.com/ajax/libs/bulma/0.6.1/css/bulma.min.css');
...
var author$project$Style$content = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$width(
			rtfeldman$elm_css$Css$px(1060)),
			A2(
...
var author$project$Page$view = function (content) {
	return A2(
		rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[author$project$Style$content]))
			]),
		_List_fromArray(
			[author$project$Style$bulma, author$project$Page$viewHeader, content]));
};
var author$project$Page$Category$Append = {$: 'Append'};
...
var author$project$Page$Category$viewLinks = function (category) {
	return elm$core$List$isEmpty(category.links) ? rtfeldman$elm_css$Html$Styled$text('Liste de liens désespéremment vide...') : A2(
		rtfeldman$elm_css$Html$Styled$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$text('Liste des liens')
					])),
				A2(
				rtfeldman$elm_css$Html$Styled$div,
				_List_Nil,
				A2(elm$core$List$map, author$project$Page$Category$viewLink, category.links))
			]));
};
var author$project$Style$create = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$position(rtfeldman$elm_css$Css$absolute),
			rtfeldman$elm_css$Css$right(
...
var author$project$Page$Category$editCategory = function (model) {
	var _n0 = _Utils_Tuple2(model.selectedCategory, model.isPopUpActive);
	if ((_n0.a.$ === 'Just') && _n0.b) {
		var category = _n0.a.a;
		return A2(
			rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$Attributes$class('modal is-active'),
					A2(rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'aria-label', 'Modal title')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$Attributes$class('modal-background'),
							rtfeldman$elm_css$Html$Styled$Events$onClick(author$project$Page$Category$TogglePopup)
						]),
					_List_Nil),
					A2(
					rtfeldman$elm_css$Html$Styled$div,
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$Attributes$class('modal-card')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$Attributes$class('modal-card-head')
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											rtfeldman$elm_css$Html$Styled$Attributes$class('modal-card-title')
										]),
									_List_fromArray(
										[
											A2(
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															rtfeldman$elm_css$Html$Styled$text(category.name)
														]))
												]))
										])),
									A2(
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$Attributes$class('modal-card-body')
								]),
							_List_fromArray(
								[
									author$project$Page$Category$viewLinks(category)
								]))
						]))
				]));
	} else {
...
var author$project$Page$Category$styleListCategories = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$paddingTop(
			rtfeldman$elm_css$Css$px(50))
		]));
var author$project$Page$Category$Delete = function (a) {
	return {$: 'Delete', a: a};
};
var author$project$Page$Category$Select = function (a) {
	return {$: 'Select', a: a};
};
var author$project$Page$Category$getNumberLinks = function (links) {
...
var author$project$Page$Category$styleItemButton = rtfeldman$elm_css$Css$Global$global(
	_List_fromArray(
		[
			A2(
...
var author$project$Page$Category$styleItemOnHover = rtfeldman$elm_css$Css$Global$global(
	_List_fromArray(
		[
			A2(
			rtfeldman$elm_css$Css$Global$selector,
...
var author$project$Page$Category$viewCategory = function (category) {
	return A2(
		rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				rtfeldman$elm_css$Html$Styled$Attributes$class('categoryItem')
			]),
		_List_fromArray(
			[
				author$project$Page$Category$styleItemButton,
				author$project$Page$Category$styleItemOnHover,
				A2(
				rtfeldman$elm_css$Html$Styled$a,
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$Attributes$class('button is-link is-rounded'),
						rtfeldman$elm_css$Html$Styled$Events$onClick(
						author$project$Page$Category$Select(category.id))
					]),
				_List_fromArray(
					[
						...
						_Utils_ap(
							category.name,
							author$project$Page$Category$getNumberLinks(category.links)))
					])),
				A2(
				rtfeldman$elm_css$Html$Styled$a,
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$Attributes$id('deleteCategory'),
						rtfeldman$elm_css$Html$Styled$Attributes$class('delete is-small'),
						rtfeldman$elm_css$Html$Styled$Events$onClick(
						author$project$Page$Category$Delete(category.id))
					]),
				_List_Nil)
			]));
};
var author$project$Page$Category$viewCategories = function (categories) {
	return elm$core$List$isEmpty(categories) ? rtfeldman$elm_css$Html$Styled$text('Liste désespéremment vide...') : A2(
		rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[author$project$Page$Category$styleListCategories]))
			]),
		A2(elm$core$List$map, author$project$Page$Category$viewCategory, categories));
};
var author$project$Page$Category$view = function (model) {
	return A2(
		rtfeldman$elm_css$Html$Styled$div,
		_List_Nil,
		_List_fromArray(
			[
				rtfeldman$elm_css$Html$Styled$text('page category'),
				A2(
				rtfeldman$elm_css$Html$Styled$input,
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$Attributes$class('input'),
						rtfeldman$elm_css$Html$Styled$Attributes$placeholder('Nom...'),
						rtfeldman$elm_css$Html$Styled$Attributes$value(model.newCategoryName),
						rtfeldman$elm_css$Html$Styled$Events$onInput(author$project$Page$Category$Edit)
					]),
				_List_Nil),
				A2(
				rtfeldman$elm_css$Html$Styled$span,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$Attributes$class('button is-primary is-rounded'),
								rtfeldman$elm_css$Html$Styled$Events$onClick(author$project$Page$Category$Append)
							]),
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text('Créer')
				...
				author$project$Page$Category$viewCategories(model.categories),
				author$project$Page$Category$editCategory(model)
			]));
};
...
var author$project$Main$view = function (_n0) {
	...
	return A2(
		...
		author$project$Main$CategoryMsg,
		author$project$Page$view(
			author$project$Page$Category$view(category)));
};
